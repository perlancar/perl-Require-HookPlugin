...
package Require::HookChain::debug::dump_source::logger;
...
sub Require::HookChain::debug::dump_source::logger::INC {
    my ($self, $r) = @_;
    ...
    log_trace "Require::HookChain::debug::dump_source::logger: source code of %s <<END_DUMP\n%s\nEND_DUMP", $r->filename,
}
